...
{
    public static class ApplicationScopeConstants
    {
        ...
        public static IReadOnlySet<string> All { get; } = new[]
            {
                WorkspaceCreate, WorkspaceRead, WorkspaceWrite, MemoryRead, MemoryWrite, SourceRead, SourceWrite,
                ArtifactRead, ArtifactWrite, ContextRead
            }
