namespace Espada.Domain.Rules
{
    public class DomainResult
    {
        ...
        public static DomainResult<TValue> Failure<TValue>(DomainError error)
        {
            return new DomainResult<TValue>(default, false, error);
        }
    }
    ...
    public sealed class DomainResult<TValue> : DomainResult
    {
        ...
        public static new DomainResult<TValue> Failure(DomainError error)
        {
            return new DomainResult<TValue>(default, false, error);
        }
    }
