...
public sealed class SourceLocator : ValueObject
{
    ...
    public static DomainResult<SourceLocator> Create(string? value)
    {
        ...
        return normalized.Length > MaxLength ? DomainResult<SourceLocator>.Failure(SourceErrors.LocatorTooLong) : DomainResult<SourceLocator>.Success(new SourceLocator(normalized));
    }
