...
{
    public static class DbTableConstants
    {
        ...
        public const string InstructionRules = "InstructionRules";
        public const string PolicyRules = "PolicyRules";
        public const string MemoryMetadata = "MemoryMetadata";
        ...
        public const string WorkspaceMemberships = "WorkspaceMemberships";
        public const string BillingCustomers = "BillingCustomers";
