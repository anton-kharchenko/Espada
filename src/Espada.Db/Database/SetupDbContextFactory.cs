...
public sealed class SetupDbContextFactory : IDesignTimeDbContextFactory<SetupDbContext>
{
    ...
    {
        string connectionString = Environment.GetEnvironmentVariable(DbConstants.ConnectionStringEnvironmentVariable) ?? throw new InvalidOperationException("Connection strings cannot be null");
