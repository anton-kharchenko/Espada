...
internal sealed class WorkspaceMembershipConfiguration : IEntityTypeConfiguration<Models.WorkspaceMemberships>
{
    public void Configure(EntityTypeBuilder<Models.WorkspaceMemberships> builder)
    {
        ...
        builder.HasIndex(membership => new
        {
            ...
            .IsUnique();
        builder.HasOne<Models.Workspaces>()
            .WithMany()
