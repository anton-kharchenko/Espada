...
{
    internal sealed class WorkspaceMembershipAuthorizationFilter(IWorkspaceMembershipRepository membershipRepository)
        : IAsyncAuthorizationFilter
    {
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            if (string.IsNullOrWhiteSpace(issuer)
                ...
                || !await membershipRepository.IsMemberAsync(WorkspaceId.Create(workspaceId), issuer, subject,
