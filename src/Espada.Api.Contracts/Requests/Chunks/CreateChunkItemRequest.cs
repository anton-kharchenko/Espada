...
namespace Espada.Api.Contracts.Requests.Chunks
{
    ...
    {
        [Range(1, int.MaxValue)] public int Number { get; init; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Source start and source length must be provided together.",
                    [nameof(SourceStart), nameof(SourceLength)]);
            }
