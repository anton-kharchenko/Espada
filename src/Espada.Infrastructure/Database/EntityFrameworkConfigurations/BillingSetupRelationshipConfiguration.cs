...
{
    internal sealed class BillingSetupRelationshipConfiguration : IEntityTypeConfiguration<BillingCustomers>,
        IEntityTypeConfiguration<UsageLedgerEntries>, IEntityTypeConfiguration<UsageReconciliationOutbox>
    {
