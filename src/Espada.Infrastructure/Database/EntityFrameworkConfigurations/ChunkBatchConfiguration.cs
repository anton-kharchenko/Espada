...
namespace Espada.Infrastructure.Database.EntityFrameworkConfigurations
{
    internal sealed class ChunkBatchConfiguration : IEntityTypeConfiguration<ChunkBatch>,
        IEntityTypeConfiguration<ChunkBatches>
    {
        public void Configure(EntityTypeBuilder<ChunkBatch> builder)
        {
            ...
            builder.Property(e => e.Status)
                ...
                .HasConversion(status => status.Id,
                    value => Enumeration.GetAll<ChunkBatchStatusType>().Single(status => status.Id == value))
                .IsRequired()
                .UsePropertyAccessMode(PropertyAccessMode.Field);
        ...
        public void Configure(EntityTypeBuilder<ChunkBatches> builder)
        {
            ...
            builder.HasOne<ChunkingStrategyTypes>().WithMany().HasForeignKey(model => model.StrategyId)
                .OnDelete(DeleteBehavior.Restrict);
            builder.HasOne<ChunkBatchStatusTypes>().WithMany().HasForeignKey(model => model.StatusId)
                .OnDelete(DeleteBehavior.Restrict);
            ...
            builder
                .HasIndex(model => new { model.ArtifactRevisionId, model.StrategyId, model.StrategyVersion })
                .HasDatabaseName(
