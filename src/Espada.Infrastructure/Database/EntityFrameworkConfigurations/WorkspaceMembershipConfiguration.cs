...
internal sealed class WorkspaceMembershipConfiguration : IEntityTypeConfiguration<WorkspaceMembership>, IEntityTypeConfiguration<Espada.Db.Models.WorkspaceMemberships>
{
    ...
    public void Configure(EntityTypeBuilder<Espada.Db.Models.WorkspaceMemberships> builder)
    {
        ...
        builder.HasIndex(membership => new
        {
            ...
            .IsUnique();
        builder.HasOne<Espada.Db.Models.Workspaces>()
            .WithMany()
            .HasForeignKey(membership => membership.WorkspaceId)
            .OnDelete(DeleteBehavior.Restrict);
    }
