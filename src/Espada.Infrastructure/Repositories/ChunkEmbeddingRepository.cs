            ...
            return await dbContext.ChunkEmbeddings
                ...
                .SingleOrDefaultAsync(
                    embedding =>
                        ...
                        EF.Property<string>(embedding, Db.Constants.DbConstants.Properties.ChunkEmbeddingModelIdentifier) == model.Identifier &&
                        EF.Property<string>(embedding, Db.Constants.DbConstants.Properties.ChunkEmbeddingModelVersion) == model.Version,
                    cancellationToken);
        }
