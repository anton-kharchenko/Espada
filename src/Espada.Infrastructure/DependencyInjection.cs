...
namespace Espada.Infrastructure
{
    public static class DependencyInjection
    {
            ...
            IConfiguration? configuration = null)
        {
            ...
            services.AddScoped<OneTimeBootstrapCodeStore>();
            ...
            services.AddTransient<IEmbeddingGeneratorService>(serviceProvider =>
                serviceProvider.GetRequiredService<
                    OpenAiCompatibleEmbeddingGeneratorService>());
            services.AddTransient<IBatchEmbeddingGeneratorService>(serviceProvider =>
                serviceProvider.GetRequiredService<
                    OpenAiCompatibleEmbeddingGeneratorService>());
