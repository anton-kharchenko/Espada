...
internal static class WebsiteInfrastructure
{
    public static IDictionary<string, object?> Create(string location)
    {
        ...
        var apexDomain = new AzureClassic.AppService.StaticWebAppCustomDomain("website-apex-domain", new()
        {
        ...
        var wwwDomain = new AzureClassic.AppService.StaticWebAppCustomDomain("website-www-domain", new()
        {
