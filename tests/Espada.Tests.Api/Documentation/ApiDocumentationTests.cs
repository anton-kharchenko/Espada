    ...
    public sealed class ApiDocumentationTests(EspadaApiFactory factory) : IClassFixture<EspadaApiFactory>
    {
        ...
        public async Task OpenApi_ShouldDescribeApiKeySecurity()
        {
            ...
            HttpResponseMessage response =
                await client.GetAsync(ApiRouteConstants.OpenApi, TestContext.Current.CancellationToken);
            ...
            using JsonDocument document =
                await JsonDocument.ParseAsync(content, cancellationToken: TestContext.Current.CancellationToken);
            ...
            string securityScheme =
                paths.GetProperty("/api/v1/workspaces/{workspaceId}").GetProperty("get").GetProperty("security")[0]
        ...
        public async Task Scalar_ShouldBePubliclyAvailable()
        {
            ...
            HttpResponseMessage response =
                await client.GetAsync(ApiRouteConstants.Scalar, TestContext.Current.CancellationToken);
