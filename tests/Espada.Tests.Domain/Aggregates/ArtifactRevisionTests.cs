...
namespace Espada.Tests.Domain.Aggregates
{
    public sealed class ArtifactRevisionTests
    {
        ...
        public void CreateRevision_WhenNoRevisionExists_ShouldCreateFirstRevision()
        {
            ...
            // Act
            DomainResult<ArtifactRevision> result = artifact.CreateRevision(TestIds.FirstRevisionId, content,
                TestDates.FirstRevisionCreatedAtUtc);
        ...
        public void CreateRevision_WhenRevisionAlreadyExists_ShouldIncrementRevisionNumber()
        {
            ...
            ArtifactRevision firstRevision = artifact
                .CreateRevision(TestIds.FirstRevisionId, CreateContent("First revision"),
                    TestDates.FirstRevisionCreatedAtUtc)
                .ShouldSucceed();
            ...
            ArtifactRevision secondRevision = artifact
                .CreateRevision(TestIds.SecondRevisionId, CreateContent("Second revision"),
                    TestDates.SecondRevisionCreatedAtUtc)
                .ShouldSucceed();
        ...
        public void CreateRevision_ShouldUpdateCurrentRevisionInformation()
        {
            ...
            ArtifactRevision revision = artifact
                .CreateRevision(TestIds.FirstRevisionId, CreateContent("Revision content"),
                    TestDates.FirstRevisionCreatedAtUtc)
                .ShouldSucceed();
        ...
        public void CreateRevision_WhenCalledTwice_ShouldPointToLatestRevision()
        {
            ...
            artifact.CreateRevision(TestIds.FirstRevisionId, CreateContent("First revision"),
                    TestDates.FirstRevisionCreatedAtUtc)
                .ShouldSucceed();
        ...
        public void CreateRevision_ShouldRaiseRevisionCreatedEvent()
        {
            ...
            // Assert
            ArtifactRevisionCreatedDomainEvent domainEvent =
                artifact.ShouldHaveSingleDomainEvent<ArtifactRevisionCreatedDomainEvent>();
        ...
        public void CreateRevision_WhenArtifactIsArchived_ShouldReturnFailure()
        {
            ...
            // Act
            DomainResult<ArtifactRevision> result = artifact.CreateRevision(TestIds.FirstRevisionId,
                CreateContent("Forbidden revision"), TestDates.LaterUtc);
        ...
        {
            return ArtifactContent.Create(value).ShouldSucceed();
        }
    }
}