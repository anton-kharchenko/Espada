...
namespace Espada.Tests.Domain.Aggregates
{
    public sealed class WorkspaceTests
    {
        ...
        public void Create_WithValidArguments_ShouldRaiseCreatedEvent()
        {
            ...
            // Assert
            WorkspaceCreatedDomainEvent domainEvent =
                workspace.ShouldHaveSingleDomainEvent<WorkspaceCreatedDomainEvent>();
        ...
        public void Archive_WhenWorkspaceIsActive_ShouldRaiseArchivedEvent()
        {
            ...
            // Assert
            WorkspaceArchivedDomainEvent domainEvent =
                workspace.ShouldHaveSingleDomainEvent<WorkspaceArchivedDomainEvent>();
