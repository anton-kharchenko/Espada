...
namespace Espada.Tests.Domain.Aggregates
{
    public sealed class ImportPipelineStateTests
    {
        ...
        {
            ImportJob importJob = ImportJob.Request(TestIds.DefaultImportJobId, TestIds.DefaultSourceId,
                TestIds.DefaultWorkspaceId, TestDates.ImportRequestedAtUtc, "request-123", "sha256:payload",
                """{"chunking":{"strategy":"Recursive"}}""").ShouldSucceed();
        ...
        public void CompleteStage_WhenStartSucceeded_ShouldScheduleReadExactlyOnce()
        {
            ...
            ImportStageScheduledDomainEvent domainEvent =
                importJob.ShouldHaveSingleDomainEvent<ImportStageScheduledDomainEvent>();
