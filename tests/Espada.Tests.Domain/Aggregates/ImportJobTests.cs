    ...
    public sealed class ImportJobTests
    {
        ...
        public void Request_WithValidArguments_ShouldRaiseRequestedEvent()
        {
            ...
            ImportJobRequestedDomainEvent domainEvent =
                importJob.ShouldHaveSingleDomainEvent<ImportJobRequestedDomainEvent>();
        ...
        public void Start_WhenRequested_ShouldRaiseStartedEvent()
        {
            ...
            // Assert
            ImportJobStartedDomainEvent domainEvent =
                importJob.ShouldHaveSingleDomainEvent<ImportJobStartedDomainEvent>();
        ...
        public void Complete_WhenRunning_ShouldMarkImportAsSucceeded()
        {
            ...
            // Act
            DomainResult result = importJob.Complete(TestIds.DefaultArtifactId, TestIds.FirstRevisionId,
        ...
        public void Complete_WhenRunning_ShouldRaiseCompletedEvent()
        {
            ...
            // Assert
            ImportJobCompletedDomainEvent domainEvent =
                importJob.ShouldHaveSingleDomainEvent<ImportJobCompletedDomainEvent>();
        ...
        public void Fail_WhenRunning_ShouldRaiseFailedEvent()
        {
            ...
            // Assert
            ImportJobFailedDomainEvent
                domainEvent = importJob.ShouldHaveSingleDomainEvent<ImportJobFailedDomainEvent>();
        ...
        public void Cancel_WhenAllowed_ShouldRaiseCancelledEvent()
        {
            ...
            // Assert
            ImportJobCancelledDomainEvent domainEvent =
                importJob.ShouldHaveSingleDomainEvent<ImportJobCancelledDomainEvent>();
        ...
        public void CompletedImportJob_ShouldRejectFurtherTransitions()
        {
            ...
            DomainResult completeResult =
                importJob.Complete(TestIds.DefaultArtifactId, TestIds.FirstRevisionId, TestDates.LaterUtc);
        ...
        public void FailedImportJob_ShouldRejectFurtherTransitions()
        {
            ...
            DomainResult failResult =
                importJob.Fail(ImportFailure.Create("another.failure", "Another failure.").ShouldSucceed(),
                    TestDates.LaterUtc);
