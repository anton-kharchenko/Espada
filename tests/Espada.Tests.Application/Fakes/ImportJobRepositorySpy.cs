...
namespace Espada.Tests.Application.Fakes
{
    internal sealed class ImportJobRepositorySpy : IImportJobRepository
    {
        ...
        public IReadOnlyList<ImportJob> ImportJobsToReturn { get; set; } = [];
        ...
        public Task<IReadOnlyList<ImportJob>> ListByWorkspaceIdAsync(
            WorkspaceId workspaceId,
            CancellationToken cancellationToken = default)
        {
            return Task.FromResult(ImportJobsToReturn);
        }
