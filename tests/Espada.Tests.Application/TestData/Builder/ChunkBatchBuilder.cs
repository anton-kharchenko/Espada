...
namespace Espada.Tests.Application.TestData.Builder
{
    internal sealed class ChunkBatchBuilder
    {
        ...
        public ChunkBatchBuilder WithId(ChunkBatchId id)
        {
            _id = id;
            return this;
        }

        public ChunkBatchBuilder InWorkspace(WorkspaceId workspaceId)
        {
            _workspaceId = workspaceId;
            return this;
        }

        public ChunkBatchBuilder ForArtifact(ArtifactId artifactId)
        {
            _artifactId = artifactId;
            return this;
        }

        public ChunkBatchBuilder ForRevision(ArtifactRevisionId artifactRevisionId)
        {
        ...
        public ChunkBatch BuildWithoutPendingEvents()
        {
            ...
            DomainResult<ChunkBatch> result = ChunkBatch.Request(_id, _workspaceId, _artifactId, _artifactRevisionId,
                _strategy, versionResult.Value, _requestedAtUtc);
