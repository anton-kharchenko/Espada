...
namespace Espada.Tests.E2E.Fixtures
{
    public sealed class EspadaE2EFactory : IAsyncLifetime
    {
        ...
        private IServiceProvider Services =>
            (_factory ?? throw new InvalidOperationException("E2E factory is not initialized.")).Services;
        ...
        public async ValueTask InitializeAsync()
        {
            ...
            if (pendingMigrations.Length > 0)
            {
                throw new InvalidOperationException(
                    $"Pending migrations remain after E2E fixture initialization: {string.Join(", ", pendingMigrations)}");
            }
        }
        ...
        public HttpClient CreateClient(bool authenticated = true)
        {
            WebApplicationFactory<Program> factory =
                _factory ?? throw new InvalidOperationException("E2E factory is not initialized.");
